...
static WinnerTakesAllParam params[] = {
    {64, 0.95f, sgm::PathType::SCAN_4PATH, false},  {64, 0.95f, sgm::PathType::SCAN_4PATH, true},   {64, 0.95f, sgm::PathType::SCAN_8PATH, false},
...
namespace sgm
{
    ...
    void winner_takes_all(const HostImage &L, HostImage &D1, HostImage &D2, int disp_size, float uniqueness, bool subpixel, PathType path_type)
    {
        const int w = D1.cols;
        const int h = D1.rows;
