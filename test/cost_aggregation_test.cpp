...
static CostAggregationParam params[] = {
    {sgm::SGM_32U, 64, 10, 120, +0},   {sgm::SGM_32U, 64, 10, 120, +16},  {sgm::SGM_32U, 64, 10, 120, -16},  {sgm::SGM_32U, 128, 10, 120, +0},  {sgm::SGM_32U, 128, 10, 120, +16},
    {sgm::SGM_32U, 128, 10, 120, -16}, {sgm::SGM_32U, 256, 10, 120, +0},  {sgm::SGM_32U, 256, 10, 120, +16}, {sgm::SGM_32U, 256, 10, 120, -16}, {sgm::SGM_64U, 64, 10, 120, +0},
    {sgm::SGM_64U, 64, 10, 120, +16},  {sgm::SGM_64U, 64, 10, 120, -16},  {sgm::SGM_64U, 128, 10, 120, +0},  {sgm::SGM_64U, 128, 10, 120, +16}, {sgm::SGM_64U, 128, 10, 120, -16},
    {sgm::SGM_64U, 256, 10, 120, +0},  {sgm::SGM_64U, 256, 10, 120, +16}, {sgm::SGM_64U, 256, 10, 120, -16},
    {sgm::SGM_32U, 512, 10, 120, +0},  {sgm::SGM_32U, 512, 10, 120, +16}, {sgm::SGM_32U, 512, 10, 120, -16},
    {sgm::SGM_64U, 512, 10, 120, +0},  {sgm::SGM_64U, 512, 10, 120, +16}, {sgm::SGM_64U, 512, 10, 120, -16},
};
...
namespace sgm
{
    ...
    static void cost_aggregation_(const HostImage &srcL, const HostImage &srcR, HostImage &dst, int disp_size, int P1, int P2, int min_disp, int ru, int rv)
    {
    ...
    static void cost_aggregation(const HostImage &srcL, const HostImage &srcR, HostImage &dst, int disp_size, int P1, int P2, int min_disp, int ru, int rv)
    {
    ...
    void cost_aggregation(const HostImage &srcL, const HostImage &srcR, HostImage &dst, int disp_size, int P1, int P2, PathType path_type, int min_disp)
    {
